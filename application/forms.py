...
class VisualizationSettingsForm(FlaskForm):
    ...
    x_var = SelectField("'Independent' Variable", choices=questionNames, default="recommendation")
    y_var = SelectField("'Dependent' Variable", choices=questionNames, default="drug")
